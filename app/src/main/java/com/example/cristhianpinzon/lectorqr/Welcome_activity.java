...
import com.example.cristhianpinzon.lectorqr.Logica.PrefManager;
...
public class Welcome_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.layout_welcome_slide1,
                R.layout.layout_welcome_slide2,
                R.layout.layout_welcome_slide3};
